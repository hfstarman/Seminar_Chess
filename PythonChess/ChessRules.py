...
class ChessRules:
	...
	def isKingCaptured(self, moveString):
		#Returns true if the king has been captured
		#Checks the moveReport for the capture

		white_capped = "captures white king"
		black_capped = "captures black king"

		return self.isSubstring(white_capped, moveString) or self.isSubstring(black_capped, moveString)
